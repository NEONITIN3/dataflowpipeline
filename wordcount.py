...
def main(argv=None, save_main_session=True):
  ...
  parser.add_argument(
      '--input',
      dest='input',
      default='gs://dataflowby6168/fileinput/cloudfun_with_terraform.txt',
      help='Input file to process.')
  parser.add_argument(
      '--output',
      dest='gs://dataflowby6168/fileoutput',
  ...
  pipeline_args.extend([
      ...
      # files.
      '--staging_location=gs://dataflowby6168/fileinput',
      # CHANGE 6/6: Your Google Cloud Storage path is required for temporary
      # files.
      '--temp_location=gs://dataflowby6168/fileinput',
      '--job_name=your-wordcount-job-byneonitin6168',
  ])
